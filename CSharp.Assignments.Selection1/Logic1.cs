...
namespace CSharp.Assignments.Loop1
{
    public class Logic1
    {
        ...
        public static int CaughtSpeeding(int speed, bool birthday)
        {
            ...
            else if (birthday && speed >= 66 && speed <= 85 || speed >= 61 && speed <= 80)
            {
                return 1;
            }
            else if (birthday && (speed >= 86) || speed >= 81)
            {
                return 2;
            }
        ...
        {
            if (temperature >= 60 && temperature <= 90 || isSummer && temperature >= 60 && temperature <= 100)
            {
                return true;
            }
        ...
        {
            if ((vacation) && ((dayOfWeek == DayOfWeek.Saturday) || (dayOfWeek == DayOfWeek.Sunday)))
            {
                return "off";
            }
